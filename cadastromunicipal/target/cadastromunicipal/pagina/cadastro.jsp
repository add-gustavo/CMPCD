    ...
    <header class="green-color">
        <div class="ordem-header">
            <div class="primeiro-header">
                <a href="/cadastromunicipal/inicial.jsp" class="logo align">Lorem ipsum dolor</a>
            </div>
        </div>
    ...
    <section class="align">
        ...
        <div class="section-Titulo">
            ...
            <div class="Titulo-login centerX">
                ...
                <a href="/cadastromunicipal/pagina/login.jsp" id="btt-login">Entre aqui</a>
            </div>
        </div>


        <form class="formulario align" action="/cadastromunicipal/controleuser?acao=fazer-cadastro" method="POST"
            autocomplete="on">
            <div class="section-template">
                ...
                <div class="ordem-formulario">
                    ...
                    <input type="text" name="nomelogin" id="nomelogin" placeholder="Digite seu nome de login" required>
                </div>
                <!-- Senha -->
                <div class="ordem-formulario">
                    <label for="senha">Senha:</label>
                    <input type="password" name="senha" id="senha" placeholder="Digite uma senha" required minlength="8"
                        required>
                </div>
                <div class="ordem-formulario">
            ...
            <div class="section-template">
                ...
                <div class="ordem-formulario">
                    ...
                    <input type="tel" name="telefone" id="telefone" placeholder="Digite seu telefone com DDD" required
            ...
            <div class="section-template">
                ...
                <div class="ordem-formulario">
                    ...
                    <div class="align-self">
                        <input required type="radio" name="usoMedicacao" id="usoMedicacao-sim" value="true"> <label
                            for="usoMedicacao-sim">Sim</label>
                        <input required type="radio" name="usoMedicacao" id="usoMedicacao-nao" value="false"> <label
            ...
            <div class="section-template">
                ...
                <div class="ordem-formulario">
                    ...
                    <div class="align-self">
                        <input required type="radio" name="necessidadeEquipamento" id="necessidadeEquipamento-sim"
                            value="true">
                        <label for="necessidadeEquipamento-sim">Sim</label>
                        <input required type="radio" name="necessidadeEquipamento" id="necessidadeEquipamento-nao"
                            value="false">
                ...
                <div class="ordem-formulario">
                    ...
                    <textarea name="explicacaoNecessidadeAdaptacao" id="explicacaoNecessidadeAdaptacao"
                        placeholder="Informe os transportes que necessitar de transporte Adaptado " rows="4"></textarea>
                </div>
                ...
                <div class="ordem-formulario">
                    ...
                    <div class="align-self">
                        <input required type="radio" name="necessidadeApoioEducacional"
                            id="necessidadeApoioEducacional-sim" value="true"> <label
                            for="necessidadeApoioEducacional-sim">Sim</label>
                        <input required type="radio" name="necessidadeApoioEducacional"
                            id="necessidadeApoioEducacional-nao" value="false"> <label
                            for="necessidadeApoioEducacional-nao">Não</label>
                    </div>
                </div>
                <div class="ordem-formulario">
                    <label></label>
                ...
                <div class="ordem-formulario">
                    ...
                    <div class="align-self">
                        <input required type="radio" name="necessidadeAcompanhante" id="necessidadeAcompanhante-sim"
                            value="true">
                        <label for="necessidadeAcompanhante-sim">Sim</label>
                        <input required type="radio" name="necessidadeAcompanhante" id="necessidadeAcompanhante-nao"
                            value="false">
